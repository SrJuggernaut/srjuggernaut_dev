...
export const APPWRITE_KEY_SECRET = process.env.APPWRITE_KEY_SECRET ?? ''
export const ADMIN_EMAIL = process.env.ADMIN_EMAIL ?? ''

// This aren't env variables, they are just constants but this is a good place to store them
...
export const SEO_IMAGES_STORAGE_ID = 'SEO_IMAGES_STORAGE'
export const SEO_IMAGES_STORAGE_NAME = 'SEO Images Storage'
export const MEDIA_STORAGE_ID = 'MEDIA_STORAGE'
export const MEDIA_STORAGE_NAME = 'Media Storage'
export const PROJECT_COLLECTION_ID = 'PROJECT'
